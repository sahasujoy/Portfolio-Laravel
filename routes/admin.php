...
Route::group(['middleware' => ['admin']], function () {
    ...
    Route::group(['prefix' => 'task'], function() {
        Route::get('/', [\App\Http\Controllers\V1\Admin\Task\TaskController::class, 'taskView'])->name('admin-task-view');
        Route::get('/tasks', [\App\Http\Controllers\V1\Admin\Task\TaskController::class, 'getTask'])->name('admin-task-list');
        Route::post('task/create', [\App\Http\Controllers\V1\Admin\Task\TaskController::class, 'createTask'])->name('admin-task-create');
        Route::post('task/delete', [\App\Http\Controllers\V1\Admin\Task\TaskController::class, 'deleteTask'])->name('admin-task-delete');
        Route::get('/clients/search', [\App\Http\Controllers\V1\Admin\Task\TaskController::class, 'search'])->name('clients.search');
        Route::post('/clients/create', [\App\Http\Controllers\V1\Admin\Task\TaskController::class, 'store'])->name('clients.store');
        Route::post('/ledger-entries/create', [\App\Http\Controllers\V1\Admin\Task\TaskController::class, 'ledgerEntry'])->name('ledger-entries.store');
        Route::get('/ledger-entries/list', [\App\Http\Controllers\V1\Admin\Task\TaskController::class, 'getAllLedgerEntries'])->name('admin-ledger-entry-get-all');
        Route::post('/ledger-entries/delete', [\App\Http\Controllers\V1\Admin\Task\TaskController::class, 'deleteLedger'])->name('admin-ledger-entry-delete');
